...
Public Class Iobit_Driver_Booster
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel7.Hide()
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_53466512db114987929700b91d7581b7.zip"), TextBox1.Text)
    End Sub
