...
Public Class OperaCB
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        timer1.Start
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_4ce31c03fd064b06a0d132b144e0de05.zip"), TextBox1.Text)
